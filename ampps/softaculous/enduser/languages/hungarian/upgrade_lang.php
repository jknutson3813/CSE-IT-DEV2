...
$l['no_upgrade_support'] = 'A frissítés nem támogatott ennél a szkriptnél';
...
$l['backup_type'] = 'Mentési beállítások';
$l['backup_type_exp'] = 'Válassza a teljes mentést vagy a haladó beállításokat';
$l['standard_backup'] = 'Teljes mentés (alapértelmezett)';
$l['advanced_backup'] = 'Haladó beállítások';

$l['backup_dir'] = 'Mentési könyvtár';
$l['backup_db'] = 'Mentés adatbázis';
$l['backup_wwwdir'] = 'Mentés weben elérhető könyvtár';
$l['backup_datadir'] = 'Mentés adat könyvtár';
$l['no_dir'] = 'A telepítés fájlok hiányoznak, ezért a frissítés nem folytatható';
$l['wpc_return'] = 'Vissza a telepítésekhez';
