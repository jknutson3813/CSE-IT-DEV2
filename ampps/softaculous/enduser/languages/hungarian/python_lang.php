...
$l['python_message'] = 'Python nincs telepítve. A telepítéshez, kérjük kattintson <a href="'.$globals['index'].'act=apps&app=29">ide</a>';
$l['python_title'] = 'Python nincs telepítve a szerverén';
...
$l['mail_admin'] = 'Admin Felhasználónév';
