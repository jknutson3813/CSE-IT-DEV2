...
$l['dont_auto_upgrade'] = 'Ne frissítsen automatikusan'; 
$l['minor_auto_upgrade'] = 'Csak <b>Alverzióra</b> történő frissítés'; 
$l['major_auto_upgrade'] = 'Frissítés bármelyik elérhető legújabb verzióra (<b>Főverzió</b> és <b>Alverzió</b>)'; 
$l['auto_upgrade_major'] = '(Major and Minor)'; 
$l['auto_upgrade_minor'] = '(Minor)'; 

$l['err_fetch_key'] = 'Jelenleg nem sikerült lekérni a PFX API kulcsot';
...
$l['view_items'] = 'Tételek felsorolása a készletben';
$l['ok'] = 'OK';
$l['plugins'] = 'Bővítmények';
$l['themes'] = 'Sablonok';
$l['empty_set'] = 'Jelenleg nincsenek tételek a készletben.';
...
$l['error_max_clone_script'] = 'Elérte a szkriptenként megengedett maximális (<b>&soft-1;</b>) klón számot.';
...
$l['manage_plugin_sets'] = 'Bővítmény készletek kezelése';
$l['manage_theme_sets'] = 'Sablon készletek kezelése';
