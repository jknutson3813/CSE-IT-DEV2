...
$l['java_message'] = 'Java nie jest zainstalowana. Aby ją zainstalować, kliknij <a href="'.$globals['index'].'act=apps&app=37">tutaj</a>';
$l['java_title'] = 'Java nie jest zainstalowana na serwerze';
