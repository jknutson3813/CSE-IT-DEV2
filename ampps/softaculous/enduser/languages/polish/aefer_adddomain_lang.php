...
$l['not_allowed'] = 'Nie masz uprawnień do dodawania domeny';
$l['ftp_error'] = 'Nie można połączyć z serwerem FTP';
$l['err_upload_remote'] = 'Wystąpił błąd! Nie można dodać pliku';
$l['err_fetch_file'] = 'Wystąpił błąd! Brak dostępu do pliku';
$l['err_fetch_path'] = 'Wystąpił błąd! Brak dostępu do ścieżki';
