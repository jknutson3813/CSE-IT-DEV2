...
//Theme Strings
$l['note'] = 'Note:';
$l['note_update'] = 'You can not update';
$l['note_switch'] = 'while it is running so please switch to different php version while update.';
$l['note_off'] = 'while it is running.';
$l['update'] = 'Updating';
$l['app_name'] = 'App Name:';
$l['i_version'] = 'Installed Version:';
$l['l_version'] = 'Latest Version:';
$l['location'] = 'location:';
$l['create_backup'] = 'Create Backup:';
$l['create_backup_exp'] = 'Create a Backup before updating';
$l['title'] = 'App';
$l['<title>'] = $globals['sn'];
$l['install'] = 'Install';
$l['overview'] = 'Overview';
...
$l['uptodate'] = 'is up to date';
$l['notinstall'] = 'is Not Installed';
