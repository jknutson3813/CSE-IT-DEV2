...
$l['<title>'] = 'Email Templates';
$l['heading'] = 'Email Templates';
$l['emailtemp'] = 'Email Templates';
$l['temp_install_php'] = 'New Installation Template (PHP)';
$l['temp_clone'] = 'Clone Installation Template';
$l['temp_install_js'] = 'New Installation Template (JavaScript)';
$l['temp_install_perl'] = 'New Installation Template (PERL)';
$l['temp_install_classes'] = 'New Installation Template (Classes)';
$l['temp_remove'] = 'Remove Installation Template';
$l['temp_editdetail'] = 'Edit Installation Details Template';
$l['temp_update'] = 'Updates Available Template (From ADMIN)';
$l['temp_cron'] = 'Updates Available Template (From CRON)';
...
$l['temp_pushtolive'] = 'Posunout na Live Template';
