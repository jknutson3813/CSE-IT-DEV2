...
//Theme Strings
$l['<title>'] = APP.' - Import Scripts';
$l['importing_scripts'] = 'Importing Scripts from other auto installers';
$l['no_import'] = 'No scripts to import!';
$l['importing_of'] = 'Uživatelské jméno';
$l['start_import'] = 'Start Import';
$l['import_exp'] = 'This utility will import the scripts that were installed using other Auto Installers. To begin the process please click "'.$l['start_import'].'"';
$l['no_users'] = 'No users found on the server';
