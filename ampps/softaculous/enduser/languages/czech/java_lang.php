...
$l['java_message'] = 'Java není instalovaná. Pro její instalaci klikněte <a href="'.$globals['index'].'act=apps&app=37">zde</a>';
$l['java_title'] = 'Java není instalovaná na vašem serveru.';
