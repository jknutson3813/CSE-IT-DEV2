...
$l['no_remove_functions'] = 'Soubor REMOVE FUNCTIONS nebyl nalezen! Oznamte to prosím správci serveru.';
...
$l['no_domain_verify'] = 'Vaše doména není dostupná. Zkontrolujte, prosím, zda vaše doména směřuje na tento server a nemá omezený přístup souborem .htaccess';
...
$l['auto_upgrade_enabled'] = 'Auto Upgrade k dispozici';
$l['bad'] = 'Špatné';
$l['good'] = 'Dobré';
$l['strong'] = 'Silné';
$l['short'] = 'Krátké';
...
$l['choose_theme'] = 'Zvolit motiv';
$l['clear_theme'] = 'Zrušit výběr';
$l['installing_theme'] = 'Instalování šablony';
$l['cant_download_theme'] = 'Nelze stáhnout soubory motivu';
$l['no_theme_package'] = 'Instalační balíček motivu nebyl nalezen!';
$l['unzipping_theme_files'] = 'Kopírování souborů a složek motivů';
$l['use_this_theme'] = 'Vybrat toto';
$l['err_auto_backup_limit'] = 'Automatická rotace záloh nemůže být více než <b>&soft-1;</b>';
$l['select_domain'] = 'Zvolit doménu';
$l['refresh'] = 'Obnovit';
$l['purchase'] = 'Koupit';
$l['your_purchased'] = 'Zakoupeno';//trailing space is required
$l['your_purchased_times'] = 'Čas(y)';
$l['err_theme_not_bought'] = 'Nemáte zakoupený motiv, proto jej nelze nainstalovat!';
$l['err_theme_reached_limit'] = 'Prosím kupte tento motiv a zkuste ho instalovat znovu. Dosáhli jste limitu instalování tohoto motivu.';
$l['payment_heading'] = 'Motiv nákupu';
$l['payment_redirect'] = 'Budete přesměrováni na platbu';//trailing space is required
$l['close'] = 'Zavřít';
$l['free'] = 'Zdarma';
$l['select'] = 'Vybrat';
$l['theme_is_optional'] = '<b>Poznámka</b>: Volitelné. Není-li zvoleno, bude nainstalován výchozí motiv';
$l['with_selected'] = 'S vybranými';
$l['related_scripts'] = 'Související skripty';

$l['date_added'] = 'Datum přidáno';
$l['downloaded'] = 'Staženo';
$l['soft_ins_exists'] = 'Instalace již existuje zde &soft-1;. Pro opětovnou instalaci nejdříve odstraňte instalaci původní!';
...
$l['pushtolive'] = 'Posunout na Live';
$l['staging'] = 'Vytvořit Stag';
...
$l['err_fetch_key'] = 'Momentálně se nepovedlo získat PFX API klíč';
...
$l['view_items'] = 'Zobrazit položky v setu';
$l['ok'] = 'OK';
$l['plugins'] = 'Pluginy';
$l['themes'] = 'Vzhledy';
$l['empty_set'] = 'V setu se nenachází žádné položky!';
...
$l['error_max_clone_script'] = 'Dosáhli jste maximální počtu Clonů (<b>&soft-1;</b>) pro jeden skript.';
$l['error_max_staging_script'] = 'Dosáhli jste maximální počtu Stagů (<b>&soft-1;</b>) pro jeden skript.';

$l['remove_complete'] = 'Kompletně odstranit';
$l['remove_info'] = 'Odstranit z'.APP;
$l['manage_sets'] = 'Správa sad pluginů / motivů';
$l['manage_plugin_sets'] = 'Spravovat sety pluginů';
$l['manage_theme_sets'] = 'Spravovat sety vzhledů';
