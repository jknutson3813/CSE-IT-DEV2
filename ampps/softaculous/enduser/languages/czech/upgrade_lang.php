...
$l['no_upgrade_support'] = 'Upgrade není pro tento script podporován';
...
$l['upgrade_tweet_sub'] = 'Dát vědět přátelům';

$l['backup_type'] = 'Možnosti zálohování';
$l['backup_type_exp'] = 'Zvolte kompletní zálohu, nebo pokročilé možnosti';
$l['standard_backup'] = 'Kompletní záloha (Výchozí)';
$l['advanced_backup'] = 'Pokročilé možnosti';

$l['backup_dir'] = 'Adresář zálohy';
$l['backup_db'] = 'Databáze zálohy';
$l['backup_wwwdir'] = 'Webový adresář zálohy';
$l['backup_datadir'] = 'Adresář dat zálohy';
$l['no_dir'] = 'Instalační soubory nebyly nalezeny, nebylo možné provést upgrade';
