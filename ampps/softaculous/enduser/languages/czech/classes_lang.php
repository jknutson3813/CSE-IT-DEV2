...
$l['no_info_file'] = 'Žádná třída pro zadané ID';
...
$l['cant_download'] = 'Nelze stáhnout ZIP soubor.';
...
$l['in_directory_exp'] = 'Adresář je relativní k vaší domovské cestě a bude <b>vytvořen, pokud neexistuje</b>. Např. chcete-li nainstalovat na &soft-1;/dir, stačí zadat <b>dir</b>. Chcete-li nainstalovat pouze v &soft-1;/, ponechte toto prázdné.';
$l['aef_in_directory_exp'] = 'Adresář je relativní k vaší domovské cestě a bude <b>vytvořen, pokud neexistuje</b>. Např. chcete-li nainstalovat na <span id="aef_span_lang">&soft-1;</span>/dir, stačí zadat <b>dir</b>. Chcete-li nainstalovat pouze v <span id="aef_span_lang_a">&soft-1;</span>/, ponechte toto prázdné.';
...
$l['files'] = 'Soubory & Složky';
$l['modified_time'] = 'Naposledy upraveno';
$l['size'] = 'Velikost';
$l['classes_ins_error'] = 'Došlo k chybě při ukládání instalace.';
...
$l['go'] = 'Jít';
$l['download_zip'] = 'Stáhnout všechny soubory';
...
$l['prog_installing'] = 'Instaluji';// Dont remove the trailing space
$l['prog_install_complete'] = 'Instalace dokončena.';

$l['install_tweet_sub'] = 'Dát vědět přátelům';
