...
Pokud si přejete odhlásit se z odběru podobných mailů, přejděte do Control Panel -> '.APP.' -> Nastavení e-mailu
';
...
$l['mail_restore_bg_sub'] = 'Obnova vaší zálohy $scriptname započala na pozadí';
$l['mail_restore_bg'] = 'Obnova vaší zálohy $scriptname započala na pozadí. Po dokončení budete informováni e-mailem.
Podrobnosti :
Instalační cesta : $path
Instalační URL : $url
...
$l['mail_backup_bg_sub'] = 'Záloha vaší instalace $scriptname započala na pozadí';
$l['mail_backup_bg'] = 'Záloha vaší instalace $scriptname započala na pozadí. Po dokončení budete informováni e-mailem.
Podrobnosti :
Instalační cesta : $path
Instalační URL : $url
...
$l['mail_import_sub'] = 'Import vaší instalace $scriptname';
$l['mail_import'] = 'The Import vaší instalace $scriptname was completed successfully.
Podrobnosti :
Instalační cesta : $path
Instalační URL : $url
...
$l['mail_import_fail_sub'] = 'Failed : Import vaší instalace $scriptname';
$l['mail_import_fail'] = 'The Import vaší instalace $scriptname did not complete successfully.
Podrobnosti :
Instalační cesta : $path
Instalační URL : $url

Objevil se následující problém :
$error

Zkuste, prosím, instalaci znovu importovat později.

Pokud si přejete odhlásit se z odběru podobných mailů, přejděte do Control Panel -> '.APP.' -> Nastavení e-mailu
';

// Import Background Language Strings
$l['mail_import_bg_sub'] = 'Import vaší instalace $scriptname';
$l['mail_import_bg'] = 'The Import vaší instalace $scriptname has started in the background. You will receive an email notification about the status once the import process is completed.
Podrobnosti :
Instalační cesta : $path
Instalační URL : $url
...
$l['mail_autoupgrade_extras_restore_fail_user_sub'] = 'Automatická aktualizace vašeho pluginu/tématu v instalaci $scriptname selhala.';
...
$l['mail_autoupgrade_extras_fail_user_sub'] = 'Automatická aktualizace vašeho pluginu/tématu v instalaci $scriptname selhala.';
...
$l['mail_clone_fail_sub'] = 'Selhání : Kopie instalace $scriptname';
$l['mail_clone_fail'] = 'Kopírování instalace $scriptname nebylo správně dokončeno.
Podrobnosti :
Instalační cesta : $path
Instalační URL : $url
...
// clone fail Language Strings
$l['mail_staging_fail_sub'] = 'Selhání : Stagování instalace $scriptname';
$l['mail_staging_fail'] = 'Stagování instalace $scriptname nebylo správně dokončeno.
Podrobnosti :
Instalační cesta : $path
Instalační URL : $url
...
$l['mail_upgrade_fail_sub'] = 'Selhání: Upgrade vaší instalace $scriptname';
$l['mail_upgrade_fail'] = 'Upgrade instalace $scriptname nebylo správně dokončeno.
Podrobnosti :
Instalační cesta : $path
Instalační URL : $url
...
Zkuste, prosím, upgrade znovu později.
...
$l['package_error'] = 'Objevily se chyby v instalačním balíčku.';
