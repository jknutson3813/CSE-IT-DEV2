...
$l['err_max_local_backups'] = 'È stato raggiunto il numero massimo di (<b>&soft-1;</b>) backup locali consentiti. Eliminare i backup indesiderati sul server locale per poter eseguire un nuovo backup.';
$l['err_max_insid_backups'] = 'Hai raggiunto il numero massimo di (<b>&soft-1;</b>) backup consentiti per questa installazione. Eliminare i backup indesiderati per questa installazione per poter eseguire un nuovo backup.';
$l['err_max_local_insid_backups'] = 'Hai raggiunto il numero massimo di (<b>&soft-1;</b>) backup locali consentiti per questa installazione. Elimina i backup indesiderati per questa installazione sul server locale per poter eseguire un nuovo backup.';
