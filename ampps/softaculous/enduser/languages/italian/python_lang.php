...
$l['python_message'] = 'Python is not installed. To install it, please click <a href="'.$globals['index'].'act=apps&app=29">qui</a>';
$l['python_title'] = 'Python non è installato sul tuo server';
