...
$l['no_protocol'] = 'Protocollo non valido';
$l['not_allowed'] = 'Non sei autorizzato ad aggiungere un dominio';
...
//Theme Strings
$l['<title>'] = 'Aggiungi un dominio';
$l['add_domain'] = 'Aggiungi dominio';
...
$l['backup_path_exp'] = 'The Percorso di backup for your Backup made by Softaculous e.g. /backups';
$l['data_dir'] = 'Directory dei dati';
$l['data_dir_exp'] = 'Percorso completo verso la directory dei dati ad es. /home/UTENTE/datadir
Alcuni script come Elgg, Moodle, etc richiedono una cartella non accessibile dal web.
Questo sarà utilizzato a tale scopo.';
$l['ins_email_exp'] = 'Quando installi un nuovo software, invia una mail con i dettagli d\'installazione';
$l['submit_add'] = 'Test and Save Dominio';
...
$l['server_host_exp'] = 'Se il tuo nome a dominio e il server host non sono identici inserire il server host ad es. ftp.mydomain.com';
