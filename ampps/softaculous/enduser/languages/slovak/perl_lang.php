...
$l['www_files_exist'] = 'Inštalácia nemôže pokračovať, pretože nasledujúce súbory v priečinku WEB už existujú';
...
$l['wwwdir_invalid'] = 'Priečinok WWW, ktorý ste zadali je neplatný.';
...
$l['no_perl_install'] = 'PERL nie je nainštalovaný. Pre inštaláciu, prosím, kliknite <a href="'.$globals['index'].'act=apps&app=19">sem</a>';
...
$l['wwwdir'] = 'Webový priečinok';
$l['wwwdir_exp'] = 'Priečinok prístupný z webu';
