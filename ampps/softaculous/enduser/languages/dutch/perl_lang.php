...
$l['www_files_exist'] = 'De installtie kan niet worden voltooid omdat de onderstaande bestanden reeds aanwezig zijn:';
$l['no_decompress_www'] = 'Er zijn fouten opgetreden tijdens het uitpakken van bestanden';
$l['no_config_perl_path'] = 'Er zijn fouten opgetreden tijdens e configuratie van de CGI bestanden';
$l['mail_wwwdir'] = 'Web directory';
$l['wwwdir_invalid'] = 'U heeft geen geldige www directory opgegeven';
...
$l['softcopy_note'] = '<b> Let op </b>: Dit script vereist dat de installatie wordt voltooid via een aparte webinstaller. <br />U kunt de installatie voltooien via de url die zal verschijnen nadat de bestanden van het script zijn geupload naar uw account.';//<b>NOTE</b>: This software requires to install using its Own Installation Utility. So please visit the URL that will be shown once the files have been copied, to complete the Installation Process.
...
$l['inst_remvd'] = 'De geselecteerde installaties zijn verwijderd. Deze pagina zal opnieuw worden geopent!';
$l['remove'] = 'Verwijder';
$l['go'] = 'Ga';
