...
$l['in_directory'] = 'In Directory (Optional)';
...
$l['please_note'] = '<b>NOTE</b>: '.APP.' is just a auto installer and does not provide any support for the software packages. Please visit the script or software\'s web site for any kind of support!';
$l['regards'] = 'Regards';
