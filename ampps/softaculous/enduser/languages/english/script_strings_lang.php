...
$l['ss']['err_php56'] = 'The PHP Version is less than the required 5.6+';
...
$l['ss']['err_passsall'] = 'Password must contain at least one uppercase, one lowercase, one digit and one special character';
