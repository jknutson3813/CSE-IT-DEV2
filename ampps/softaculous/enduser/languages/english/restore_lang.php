...
$l['restoring'] = 'Your backup is being restored in background. You will be notified by email once its completed. You can track the restore process from the <a href="'.$globals['index'].'act=eu_tasklist">Task List</a> page.';
