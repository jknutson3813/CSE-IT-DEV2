...
$l['backedup'] = 'The backup was created successfully. You can access it from the <a href="'.$globals['index'].'act=backups">Backups</a> page.<br /> Your installation URL : <a href="&soft-1;" target="_blank">&soft-1;</a>';
...
$l['backingup'] = 'The backup is being created in the background. You will be notified by email once its completed.<br /> After the backup is completed, you can access it from the <a href="'.$globals['index'].'act=backups">Backups</a> page.<br /> Your installation URL : <a href="&soft-1;" target="_blank">&soft-1;</a>';
