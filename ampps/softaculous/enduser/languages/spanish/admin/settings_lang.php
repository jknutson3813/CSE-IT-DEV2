...
$l['php_bin_exp'] = 'Este es el bin que se usará para CRON Job. Si se deja vacío entonces se utilizará <b>/usr/bin/php</b>. Tenga en cuenta que el <b> binario de PHP debe ser un binario de CLI </b>.';
