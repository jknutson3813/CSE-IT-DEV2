...
$l['<title>'] = 'Plantillas de Email ';
$l['heading'] = 'Plantillas de Email';
$l['emailtemp'] = 'Email Templates';
$l['temp_install_php'] = 'Nueva Plantilla de Instalacion (PHP)';
$l['temp_clone'] = 'Clone Installation Template';
$l['temp_install_js'] = 'Nueva Plantilla de Instalacion (JavaScript)';
$l['temp_install_perl'] = 'Nueva Plantilla de Instalacion (PERL)';
$l['temp_install_classes'] = 'Nueva Plantilla de Instalacion (Classes)';
$l['temp_remove'] = 'Eliminar Plantilla de Instalacion';
$l['temp_editdetail'] = 'Editar Detalles de Plantilla de Instalacion';
$l['temp_update'] = 'Actualizacion de Plantillas disponibles (desde ADMIN)';
$l['temp_cron'] = 'Actualizacion de Plantillas disponibles(desde CRON)';
$l['temp_backup'] = 'Backup creado satisfactoriamente';
$l['temp_backup_bg'] = 'Backup started in background';
$l['temp_backup_fail'] = 'Backup erroneo';
$l['temp_restore'] = 'Backup restaurado satisfactoriamente';
$l['temp_restore_fail'] = 'Error de restauracion de Backup';
...
$l['tempname'] = 'Nombre de Plantilla';
$l['options'] = 'Opciones';
