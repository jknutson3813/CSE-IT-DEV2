...
//Theme Strings
$l['<title>'] = APP.' - Gestión de WordPress';
$l['wordpress_management'] = 'Gestión de WordPress';
$l['install'] = 'Instalar';
$l['upgrade'] = 'Upgrade';
$l['manage_sets'] = 'Manage Sets';
$l['scan'] = 'Escanear';
$l['check_updates'] = 'Buscar actualizaciones';
$l['remove'] = 'Borrar';
$l['security_measures'] = 'Security Measures';
$l['uninstall'] = 'Desinstalar';
$l['save'] = 'Guardar';
$l['save_settings'] = 'Guardar ajustes';
$l['save_info'] = 'Guardar información del sitio';
$l['backup'] = 'Copia de seguridad';
$l['restore'] = 'Restaurar';
$l['clone'] = 'Clonar';
$l['staging'] = 'Staging';
$l['pushtolive'] = 'Cambiar la web publicada por el staging';
$l['save_all'] = 'Guardar todos los cambios';
$l['up_to_date'] = 'Actualizado';
$l['updates_available'] = 'Actualizaciones disponibles';
$l['upd_to'] = 'Actualizar a la versión';
$l['upgrade_now'] = 'Actualizar ahora';
$l['remote_import'] = 'Remote Import';
$l['backups'] = 'Backups';

$l['install_exp'] = 'Instalar una copia nueva de WordPress';
$l['scan_exp'] = 'Encontrar todas las instalaciones de WordPress en su cuenta';
$l['check_updates_exp'] = 'Buscar actualizaciones para WordPress, Themes, y plugins';
$l['remove_exp'] = 'Eliminar las instalaciones seleccionadas de '.APP.' registros';
$l['security_measures_exp'] = 'Apply and revert security measures to selected WordPress websites';
$l['uninstall_exp'] = 'Eliminar archivos / carpetas y base de datos para instalaciones seleccionadas';
...
$l['installations'] = 'Instalaciones';
$l['siteurl'] = 'URL del sitio web';
$l['site_name'] = 'Nombre del sitio';
$l['blog_public'] = 'Visibilidad del motor de búsqueda';
$l['wp_cron'] = 'Cron de WordPress (wp-cron.php)';
$l['wp_debug'] = 'Modo de depuración';
$l['enabled'] = 'Activado';
$l['disabled'] = 'Desactivado';
$l['version'] = 'Versión';
$l['updated'] = 'Actualizado';
$l['update_now'] = 'Actualizar ahora';
$l['change'] = 'Cambiar';
$l['info'] = 'Información del sitio web';
$l['updates'] = 'Actualizaciones';
$l['configuration'] = 'Configuración';
$l['manage_plugins'] = 'Administrar Plugins';
$l['manage_plugins_exp'] = 'Instalar, habilitar, deshabilitar, actualizar y eliminar plugins para esta instalación';
$l['manage_themes'] = 'Administrar Themes';
$l['manage_themes_exp'] = 'Instalar, habilitar, deshabilitar, actualizar y eliminar themes para esta instalación';
$l['options'] = 'Opciones';
$l['auto_upgrade_core'] = 'Actualización automática del núcleo de WordPress';
$l['auto_upgrade_plugins'] = 'Actualización automática de plugins de WordPress';
$l['auto_upgrade_themes'] = 'Actualización automática de themes de WordPress';
$l['dont_auto_upgrade'] = 'No actualizar automáticamente';
$l['minor_auto_upgrade'] = 'Actualizar solo a versiones menores';
$l['major_auto_upgrade'] = 'Actualizar a la última versión disponible (tanto mayor como menor)';
$l['exp_eu_auto_upgrade'] = 'Seleccionar la opción de actualización automática para el núcleo de WordPress';
$l['exp_auto_upgrade_plugins'] = 'Si está habilitado, todos los plugins de WordPress instalados para esta instalación se actualizarán automáticamente a la última versión (cada 24 horas)';
$l['exp_auto_upgrade_themes'] = 'Si está habilitado, todos los themes de WordPress para esta instalación se actualizarán automáticamente a la última versión (cada 24 horas)';
$l['login_admin'] = 'Entrar';
$l['login_exp'] = 'Entrar como usuario administrador en WordPress';
$l['clone_exp'] = 'Clonar esta instancia en una instalación separada';
$l['staging_exp'] = 'Crear una copia provisional de su instalación en vivo para probar actualizaciones o cambios';
$l['pushtolive_exp'] = 'Poner los cambios en la instalación del staging en la instalación en vivo';
$l['backup_exp'] = 'Crear una copia de seguridad de la instalación';
$l['restore_exp'] = 'Restaurar una copia de seguridad de la instalación para revertir los cambios';
$l['remove_ins_exp'] = 'Quitar esta instalación de '.APP.' registros';
$l['uninstall_ins_exp'] = 'Eliminar archivos / carpetas y base de datos de esta instalación';
...
$l['exp_blog_public'] = 'Si está habilitado, los motores de búsqueda rastrearán el sitio web. Si el sitio está en construcción, se puede desactivar y activar cuando el sitio esté activo. Predeterminado: habilitado';
$l['exp_wp_cron'] = 'Si está desactivado, el cron de WordPress se desactivará y se agregará un trabajo cron en el panel de control para que se ejecute dos veces por hora. Predeterminado: habilitado';
$l['exp_wp_debug'] = 'Si está habilitado, se habilitará el modo de depuración de WordPress que ayudará a encontrar la causa de un error en caso de error crítico. <br />Nota: No habilitar en una web que esté de cara al público. Predeterminado: deshabilitado';
$l['files_not_found'] = 'Archivos de instalación no encontrados';
...
$l['none'] = 'None';
// Error Strings
$l['off_wordpress_manager'] = 'La función de administración de WordPress ha sido deshabilitada por el administrador';
$l['no_insid'] = 'Proporciona el ID de instalación para guardar los cambios';
$l['no_softurl'] = 'Se requiere la URL del sitio';
$l['invalid_softurl'] = 'La URL del sitio no es válida';
$l['no_site_name'] = 'El nombre del sitio es obligatorio';
$l['some_error_occurred'] = 'Ocurrió algún error';
$l['domain_not_in_list'] = 'La URL publicada no está en la lista de dominios';
...
// Success strings
$l['save_info_success'] = '¡Información guardada correctamente!';
