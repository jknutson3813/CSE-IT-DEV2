...
$l['no_domain_verify'] = 'Could not access your domain. Please make sure your domain is pointing to this server and there is no .htaccess file restricting access to your domain';
...
$l['choose_url'] = 'Seleccionar URL de instalación';
$l['choose_url_exp'] = 'Por favor seleccione la URL para instalar el software';
...
$l['adv_option'] = 'Opciones avanzadas';
$l['disable_notify_update'] = 'Desactivar la notificación de actualización';
$l['exp_disable_notify_update'] = 'Si está marcado, no recibirás notificación por correo electrónico sobre las actualizaciones disponibles para esta instalación.';
...
$l['auto_upgrade_plugins'] = 'Actualización automática &soft-1; Plugins';
$l['exp_auto_upgrade_plugins'] = 'Si está marcado, todos los plugins de &soft-1; instalados para esta instalación se actualizarán automáticamente a la última versión (cada 24 horas).';
$l['auto_upgrade_themes'] = 'Actualización automática &soft-1; Temas';
$l['exp_auto_upgrade_themes'] = 'Si está marcado, todos los temas de &soft-1; para esta instalación se actualizarán automáticamente a la última versión (cada 24 horas).';
...
$l['exp_auto_backup'] = APP.' realizará automáticamente los backups a través de Cron según la frecuencia elegida';
$l['auto_backup_rotation'] = 'Rotación de Backup';
$l['exp_auto_backup_rotation'] = 'Si se ha alcanzado el límite de rotación de la copia de seguridad, '.APP.' eliminará la copia de seguridad más vieja de esta instalación y luego realizará una nueva copia de seguridad. Los backups ocupan espacio de almacenamiento, por lo tanto se recomienda elegir la rotación de backup de acuerdo con el espacio disponible en el servidor.';
$l['no_backup'] = 'No realizar backup';
$l['daily'] = 'Una vez al día';
$l['weekly'] = 'Una vez a la semana';
$l['monthly'] = 'Una vez al mes';
...
$l['choose_theme'] = 'Seleccionar tema';
...
$l['free'] = 'Free';
$l['select'] = 'Select';
$l['theme_is_optional'] = '<b>Notas</b>: Opcional. Si no se ha seleccionado, se instalará el tema predeterminado.';
...
$l['backup_location'] = 'Ubicación Backup';
$l['backup_location_exp'] = 'Elige la ubicación de la copia de seguridad que se utilizará al realizar la copia de seguridad de esta instalación';
$l['default'] = 'Por defecto';
$l['invalid_backup_location'] = 'Backup location submitted does not exist';
$l['local_folder'] = 'Carpeta local';
...
$l['quick_install'] = 'Instalación rápida';
$l['custom_install'] = 'Instalación personalizada';
...
$l['manage_plugin_sets'] = 'Gestionar Plugin';
$l['manage_theme_sets'] = 'Gestionar Conjuntos de Temas';
