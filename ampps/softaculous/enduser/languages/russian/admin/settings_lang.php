...
$l['php_bin_exp'] = 'Это двоичный код, который будет использоваться для задании cron, а также других целей. Если пусто, будет использоваться <b>/usr/bin/php</b>. Обратите внимание, что <b> PHP-двоичный файл должен быть двоичным файлом CLI </b>.';
