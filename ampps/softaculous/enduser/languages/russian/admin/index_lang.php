...
$l['no_license'] = 'Файл лицензии не может быть найден! Пожалуйста, сообщите об этом '.APP.'.';
...
$l['tab_services'] = 'Услуги'; 
$l['tab_updates'] = 'Обновление';
$l['tab_softwares'] = 'Скрипты';
$l['tab_categories'] = 'Категории';
$l['tab_email'] = 'Почта';
$l['tab_maintenance'] = 'Обслуживание';
$l['tab_proxy'] = 'Proxy';
$l['tab_installations'] = 'Установки';
$l['tab_logout'] = 'Выход'; 
$l['tab_plans'] = 'Пакеты';
$l['tab_mail_trmplate'] = 'Шаблоны Email';
...
// Sub Menus
$l['sub_outdated'] = 'Устаревшие установки';
$l['sub_byuser'] = 'По пользователям';
$l['sub_byscript'] = 'По скриптам';
$l['sub_gen_set'] = 'Основные';
$l['tab_import'] = 'Импорт';
$l['sub_custom_scripts'] = 'Собственные скрипты';
$l['sub_general_scripts'] = 'Основные скрипты';
$l['adv_software'] = 'Advanced Settings';
$l['tab_tools'] = 'Инструменты';
$l['sub_top_scripts'] = 'Выбрать TOP скрипты';
