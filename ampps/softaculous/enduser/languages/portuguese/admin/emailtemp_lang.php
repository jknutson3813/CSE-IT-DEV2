...
$l['<title>'] = 'Gabaritos de Email';
$l['heading'] = 'Gabaritos de Email';
$l['emailtemp'] = 'Gabaritos de Email';
$l['temp_install_php'] = 'Gabarito para Novas Instalações (PHP)';
$l['temp_clone'] = 'Clone Installation Template';
$l['temp_install_js'] = 'Gabarito para Novas Instalações (JavaScript)';
$l['temp_install_perl'] = 'Gabarito para Novas Instalações (PERL)';
$l['temp_install_classes'] = 'New Installation Template (Classes)';
$l['temp_remove'] = 'Gabarito de Remoção de uma Instalação';
$l['temp_editdetail'] = 'Gabarito dos Detalhes da Modificação  das Instalações';
$l['temp_update'] = 'Gabarito de Atualização Disponiveis (Da ADMIN)';
$l['temp_cron'] = 'Gabarito de Atualização Disponiveis (Da CRON)';
