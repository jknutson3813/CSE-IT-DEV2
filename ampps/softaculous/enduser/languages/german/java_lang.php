...
$l['java_message'] = 'Bitte JAVA installieren. <a href="'.$globals['index'].'act=apps&app=37">Hier ist der Link</a>';
$l['java_title'] = 'Java ist nicht auf dem Server installiert';
...
$l['databaseuser_exists'] = 'Der Datenbank Benutzer existiert bereits. Bitte wählen Sie einen andern Namen aus.';
...
$l['db_limit_crossed'] = 'Die maximale Anzahl an Datenbanken, die Sie erstellen dürfen ist erreicht, daher kann die Installation nicht fortgesetzt werden.';
...
$l['mail_new_ins'] = 'Eine neue Installtion von &soft-1; wurde abgeschlossen. Die Details der Installation sind unten aufgeführt:';
$l['mail_path'] = 'Pfad';
$l['mail_url'] = 'URL';
