...
$l['please_note'] = '<b>ВНИМАНИЕ</b>: '.APP.' е просто автоматичен инсталатор и не осигурява никаква подкрепа за софтуерни пакети. Моля посетете сайта на скрипта за всякакъв вид поддръжка!';
$l['regards'] = 'Пожелания';
