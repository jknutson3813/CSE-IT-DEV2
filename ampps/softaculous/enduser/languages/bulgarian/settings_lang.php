...
$l['no_lang'] = 'Не е избран език';
$l['wrong_lang'] = 'Езика който сте избрали не съществува';
$l['no_timezone'] = 'Не сте избрали часовата зона';
$l['timezone_invalid'] = 'Часовата зона която сте избрали е невалидна';
$l['backuploc_deleted'] = 'Backup location was deleted successfully';
$l['no_backup_loc_name'] = 'No such backup location found';

// Theme Strings
$l['<title>'] = APP.' - Потребителски настройки';
$l['choose_lang'] = 'Изберите език';
$l['exp_lang'] = 'Изберете предпочитания от вас език';
$l['menu_options'] = 'Опциите на менюто';
$l['menu_exp'] = 'Може да се ские и да разшири всички менюта!';
$l['timezone'] = 'Часова зона';
$l['default_timezone'] = 'Основен сървър';
$l['expand'] = 'Разширете';
$l['collapse'] = 'Скрийте';
$l['edit_settings'] = 'Редактиране на настройките';
$l['settings'] = 'Потребителски настройки';
$l['settings_saved'] = 'Вашите настройки са запазени успешно';
