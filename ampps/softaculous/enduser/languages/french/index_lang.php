...
Les détails de votre site de dévleoppement :
...
<if $datadirectory>Répertoire des données : $datadirectory</if>
<if $dbname>MySQL Base de Données : $dbname</if>
<if $dbuser>MySQL Utilisateur : $dbuser</if>
<if $dbhost>MySQL Host : $dbhost</if>
<if $dbpass>MySQL Mot de Passe : $dbpass</if>
<if $cron>Cron Job : $cron</if>
<if $time>Moment de l\'Installation : $time</if>

Si vous souhaitez vous désabonner de ces courriels, rendez-vous sur votre panneau de contrôle -> Email Settings';
