...
$l['all_notify_update_exp'] = 'Envoyez une notification par courrier électronique pour les mises à jour disponibles pour <b>TOUTES</b> vos installations.';
...
$l['restore_email_exp'] = 'Envoyez un courriel contenant les détails de la restauration lorsque vous restaurez une installation';
$l['done'] = 'Done';
...
$l['import_email'] = 'Importation de courriels'; 
$l['import_email_exp'] = 'Envoyez un courriel contenant les détails de l\'installation que vous avez importée'; 

$l['staging_email'] = 'Courriel lors d\'un site de développement';
$l['staging_email_exp'] = 'Envoyez un courriel contenant les détails de l\'installation lorsque vous créez un environnement de mise en scène de toute installation';