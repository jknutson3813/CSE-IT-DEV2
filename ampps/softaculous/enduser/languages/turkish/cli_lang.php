...
$l['import_complete'] = 'Import completed';
$l['import_script'] = 'Importing';
$l['sync_remote'] = 'syncing with remote server';
$l['replace_db'] = 'Replacing data in database';
$l['saving_details'] = 'Saving details';
$l['replace_content'] = 'Replacing data from files';
$l['fetch_datadir'] = 'Fetching data directory from remote server';
$l['import_db'] = 'Importing database';
