...
//Theme Strings
$l['<title>'] = APP.' - Yönetim Paneli';
$l['conect_to_soft'] = APP.'\'a bağlanılamıyor.';
$l['no_info'] = 'Bilgi Yok';
$l['news'] = APP.' Haberleri';
$l['soft_info'] = 'Yazılım Bilgisi';
$l['soft_license'] = APP.' Lisansı';
$l['soft_license_type'] = 'Lisans Tipi';
$l['type_1'] = 'Premium';
$l['type_0'] = 'Ücretsiz';
$l['type_expired'] = 'Expired';
$l['server_addr'] = 'Server IP';
$l['php_version'] = 'PHP Versiyonu';
$l['soft_version'] = APP.' Versiyonu';
$l['latest_soft_version'] = 'Son Versiyon';
$l['become_premium'] = 'Premium Lisans Al';
$l['renew_license'] = 'Renew License';
$l['refreshlicense'] = 'Lisansı Yenile';
