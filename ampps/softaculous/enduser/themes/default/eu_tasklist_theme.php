...
<div class="bg">
	<div class="row mt-2">
		<div class="col-12 text-center sai_main_head">
			<i class="fas fa-th-list fa-2x mr-1" style="color:#00A0D2;"></i>
			<span class="form-title">'.$l['errorlog_head'].'</span>
		</div>
	</div><hr />
	<div class="text-center mt-4">
		<div class="sai_sub_head" align="center">'.(!empty($no_tasks) ? $l['no_tasks'] : $l['current_tasks']).'</div>
	</div>	
	<div id="main_div">';
	...
	echo '<div id="body_progressbar'.$v['name'].'">
		<div class="row m-2 mt-4">
			...
			<div class="col-md-5 col-10">
				...
				<div class="row">
					<div class="col-md-8 col-12 sai_head" id="progress_process'.$v['name'].'"></div>
					<div class="col-md-8 col-12 sai_head" id="progress_txt'.$v['name'].'"></div>
					<div class="col-md-4 col-12 sai_head" id="progress_percent'.$v['name'].'"></div>
				</div>
			</div>		
			<div class="col-md-1 col-2" style="margin-top:10px;">
				<i class="fas fa-check fa-2x sai_icons" style="color:#45F442;" style="display:none" id="suucess_img'.$v['name'].'"></i>
			</div>
		</div>
	</div>
	<hr>';
...
function create_new_div(key){
	//alert(key);	
	var new_div = \'<div id="body_progressbar\'+key+\'"><div class="row m-2 mt-4"><div class="col-md-6 col-12"><label class="sai_head" id="progress_script\'+key+\'"></label><br /><label class="sai_head" id="progress_softurl\'+key+\'"></label><br /></div><div class="col-md-5 col-10"><div id="progressbar\'+key+\'" style="height:25px;"></div><br /><div class="row"><div class="col-md-8 col-12 sai_head" id="progress_process\'+key+\'"></div><div class="col-md-8 col-12 sai_head" id="progress_txt\'+key+\'"></div><div class="col-md-4 col-12 sai_head" id="progress_percent\'+key+\'"></div></div></div><div class="col-md-1 col-2" style="margin-top:10px;"><i class="fas fa-check fa-2x sai_icons" style="color:#45F442;" style="display:none" id="suucess_img\'+key+\'"/></i></div></div></div><hr>\';
	//alert(new_div);	
