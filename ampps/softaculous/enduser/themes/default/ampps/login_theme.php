...
$current_user = $softpanel->getCurrentUser();
	...
	<div class="container" style="opacity:1;">
		<div class="row d-flex justify-content-center login-error">
	  		...
	  		<div class="col-sm-offset-2 col-md-offset-4 col-sm-8 col-md-4 col-xs-12 login-form">
	  			<div class="row-fluid">
	  				<div class="col-sm-12 logo-login-form">
	  					...
	  					'.($globals['softpanel'] == 'ampps' ? 'src="'.$theme['a_images'].'amppslogo.gif"' : (empty($globals['logo_url']) ? ' src="'.$theme['images'].'webuzo.png"' : ' src="'.$globals['logo_url'].'"')).' alt="Panel Logo">
	  				</div>
	  			</div>
	  			<div class="row-fluid">
	  				<div class="col-sm-12">
			...
			<div class="row-fluid">
		  		<div class="col-sm-offset-2 col-md-offset-4 col-sm-8 col-md-4 col-xs-12 login-form">
		  			<div class="row-fluid">
		  				<div class="col-sm-12 logo-login-form">
		  					<img class="img-responsive center-block"
	  					'.($globals['softpanel'] == 'ampps' ? 'src="'.$theme['a_images'].'loginlogo.gif"' : (empty($globals['logo_url']) ? ' src="'.$theme['images'].'webuzo.png"' : ' src="'.$globals['logo_url'].'"')).' alt="Panel Logo">		  				
	  					</div>
		  			</div>
		  			<div class="row-fluid">
		  				<div class="col-sm-12">
