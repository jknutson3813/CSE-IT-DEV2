...
<div class="bg">
	<div class="row sai_main_head">
		<div class="col-12 my-3 text-center">
			<span class="form-title"><img height="48" width="48" src="'.$theme['a_images'].'php_conf.png" />&nbsp;'.$l['phpinihead'].'</span>
		</div>
	</div><hr />
	...
	<form accept-charset="'.$globals['charset'].'" name="editemailsettings" method="post" action="" id="editform">
		...
		<div class="row mt-4">
			<div class="col-sm-5 col-xs-12 px-4">	
				<label for ="retrieve" class="sai_head">'.$l['retrieve'].' </label>
		...
		<div class="row mt-4">
			<div class="col-sm-5 col-xs-12 px-4">	
				<label for = "restart" class="sai_head">'.$l['restart'].' </label>
	...
	<div class="row">
		<div class="col-12 px-4 text-center">
			<input type="submit" value="'.$l['save'].'" name="savephp" class="btn sai-button" id="savephp" /> &nbsp;<img id="save_php" src="'.$theme['images'].'progress.gif" style="display:none">
		</div>
	</div><br />
	</form>
</div>';
