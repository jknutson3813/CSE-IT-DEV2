...
<div class="bg">
	<div class="row sai_main_head mt-4" style="width:100%;" align="center">
		<div class="col-12 text-center">
			<span class="form-title"><img height="48" width="48" src="'.$theme['a_images'].'addftp.png" />'.$l['ftp'].'</span>
		</div>
	</div><hr />';
	...
	<form accept-charset="'.$globals['charset'].'" action="" method="post" name="ftp_account">
		...
		<div class="row mt-4">
			<div class="col-sm-5 col-xs-12 px-4">
				<label for="dir" class="sai_head ml-1">'.$l['directory'].'</label>
				<span class="sai_exp">'.$l['path'].'</span>
			</div>
			<div class="col-sm-7 col-xs-12 px-4">
		...
		<div class="row">
			<div class="col-10 px-4 text-center">
				<input type="button" style="cursor:pointer" value="'.$l['submit_button'].'" name="create_acc" class="btn sai-button" id="submitftp" />
				<img id="createftp" src="'.$theme['images'].'progress.gif" style="display:none">
			</div>
		</div>
	</form>
</div>		
