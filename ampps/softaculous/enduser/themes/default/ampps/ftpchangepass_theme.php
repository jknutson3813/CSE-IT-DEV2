	...
	<form accept-charset="'.$globals['charset'].'" action="" method="post" name="changepass">
		<div class="bg">
			<div class="row sai_main_head mt-4" style="width:100%;" align="center">
				<div class="col-12 text-center">
					<span class="form-title"><img height="48" width="48" src="'.$theme['images'].'changepassdp.gif" />&nbsp;'.$l['change_note'].'</span>
				</div>
			</div><hr />
		...
		<div class="row">
			<div class="col-10 px-4 text-center">
				<input type="button" style="cursor:pointer" value="'.$l['submit_button'].'" name="changepass" class="btn sai-button" id="submitftppass"/> &nbsp;<img id="createftppass" src="'.$theme['images'].'progress.gif" style="display:none">
			</div>
		</div><br />
		</form>
	</div>';
