...
<div class="bg">
	<div class="row sai_main_head">
		<div class="col-12 my-3 text-center">
			<span class="form-title"><img height="48" width="48" src="'.$theme['a_images'].'alias.png" />&nbsp;'.$l['alias_headling'].'</span>
		</div>
	</div><hr />
	<div id="butShow" align="right">
		<a href="javascript:void(0)" style="text-decoration:none;" color="#fff";><p class="btn sai-button">'.$l['add_new_button'].'</p></a>
	</div>	
	<div id="butHide" align="right>
		<a href="javascript:void(0)" style="text-decoration:none;" class="btn sai-button" color:#fff;>'.$l['back_button'].'</a>
	</div><br />
	...
	<div class="row mt-4">
			<div class="col-sm-5 col-xs-12 px-4">
			<label for="aliaspath" class="sai_head">'.$l['alias_path'].'</label>&nbsp;&nbsp;&nbsp;&nbsp;</br><span class="sai_exp2">'.$l['alias_path_eg'].'</span>
	...
	<div class="row">
		<div class="col-10 px-4 text-center">
			<input type="button" class="submitalias btn sai-button" style="cursor:pointer" name="submitalias" value="'.$l['submitalias'].'" /> &nbsp;<img id="createalias" src="'.$theme['images'].'progress.gif" style="display:none"></p>
		</div>
	</div>
	</form>
	<br />
