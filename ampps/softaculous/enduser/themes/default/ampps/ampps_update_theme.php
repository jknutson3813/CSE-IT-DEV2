...
function ampps_update_theme(){

	global $user, $globals, $l, $theme, $softpanel, $iscripts, $catwise, $error, $scripts, $set_warning, $php_ver;
	global $software, $soft, $a_apps, $info, $settings, $softins, $dbtype, $dbs, $upgraded, $__settings, $setupcontinue, $installations, $notes, $upgradableto, $latest_ver, $update_available, $changes;
	...
	echo '
		<div id="fadeout_div">
			...
			echo '
			<div class="bg"><br />
				<div class="row sai_main_head" style="width:100%;" align="">
					...
					<div class="col-sm-7 col-xs-7" style="padding-top:5px; padding-left:0; text-align:left;">
						'.$l['update_softaculous'].'
					</div>
				</div><hr>
				<div class="sai_divroundshad"><br />
					<div class="row">
						<div class="sai_head" align="center">'.$l['curr_ver'].'&nbsp;&nbsp;'.$globals['amp_version'].'</div>
					</div><br />
					<div class="row">
						<div class="sai_head" align="center">'.$l['latest_ver'].'&nbsp;&nbsp;&nbsp;&nbsp;'.($update_available ? '<font color="#FF0033">'.$latest_ver : '<font>'.$globals['amp_version']).'</font> </div>
					</div><br />
				</div><br />';
				
					if($update_available && $latest_ver > $globals['amp_version']){
					echo'<div class="sai_bboxtxt" style="color:#767676;">'.$changes.'</div><br />';
						if(!empty($set_warning)){
						echo'
							<div class="row"><!----#Update---->
								<div class="alert alert-warning">
								<a href = "#" class="close" data-dismiss="alert">&times;</a>
									<center><img src="'.$theme['images'].'notice.gif" /> &nbsp'.$l['change_php_warning'].'&nbsp<b>'.$php_ver.'</b>.</center>
								</div>
							</div>';
						}else{
						echo'
					...
					echo'
						<div class="row">
							<div class="col-sm-5 col-xs-5">
								<span class="sai_head" style="color:#27ae60"><u>'.$l['ampps_upto_date'].'</u></span>
							</div>
						</div>';					
					}
				echo'		
				<center>
					<b><a href="'.$globals[ind].'" class="sai_head">'.$l['return'].'</a></b>
				</center><br />
			...
			<div class="bg">
				<center>
					<div class="row sai_main_head" style="width:100%;" align="center">
						...
						<div class="col-sm-7 col-xs-7" style="padding-top:10px; padding-left:0; text-align:left;">'.$l['prog_upgrading'].'&nbsp'.$software['fullname'].'</div>
					</div>
					<br />
