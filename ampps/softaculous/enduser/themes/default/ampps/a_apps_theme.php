	...
	<div class="">
		...
		<tr>
			...
			<td valign="top" style="padding:10px;">
				...
				<table width="100%" cellpadding="4" cellspacing="1" border="0">
					<tr>
						<td width="10%" valign="top" align="center"><font color="#447edf"><i class="fas fa-inbox fa-3x"></i></font></td>
						...
						<td valign="top" align="center" width="10%"><a href="'.$software['support'].'"><font color="#447edf"><i class="fas fa-question-circle fa-3x"></i></font></a></td>
...
if(!empty($installed)){
	...
	if(empty($globals['install_tweet_off']) || empty($globals['lictype'])){
		...
		$info['overview'] .= '<form method="get" action="https://twitter.com/intent/tweet" id="tweet" onsubmit="return dotweet(this);">
...
<div id="progress_bar" style="height:125px; display: none;">
	<br />
	<center>
	<font size="4" id="progress_txt">'.$l['checking_data'].'</font>
	<font style="font-size: 18px;font-weight: 400;" id="progress_percent">(0 %)</font><br /><br />
	</center>
