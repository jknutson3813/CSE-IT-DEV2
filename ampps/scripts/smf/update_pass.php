...
$resp = password_hash(__strtolower('[[admin_username]]') . '[[admin_pass]]', PASSWORD_DEFAULT, array('cost' => 10));
echo '<update_pass>'.$resp1.'</update_pass>';

//Convert strings to lower case via vendor defined function
function __strtolower($string){
		if (function_exists('mb_strtolower')){
			return mb_strtolower($string, 'UTF-8');
		}else{
			return __utf8_strtolower($string);
		}		
}

function __utf8_strtolower($string){
	...
	$substitutions = __utf8_strtolower_maps();
...
function __utf8_strtolower_maps(){
	return array(
		"\x41" => "\x61",
		"\x42" => "\x62",
		"\x43" => "\x63",
