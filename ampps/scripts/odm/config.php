...
if (!defined('config')) {
    ...
    define('APP_DB_NAME', isset($_ENV['APP_DB_NAME']) ? $_ENV['APP_DB_NAME'] : '[[softdb]]');

    /** MySQL database username */
    define('APP_DB_USER', isset($_ENV['APP_DB_USER']) ? $_ENV['APP_DB_USER'] : '[[softdbuser]]');

    /** MySQL database password */
    define('APP_DB_PASS', isset($_ENV['APP_DB_PASS'])? $_ENV['APP_DB_PASS'] : '[[softdbpass]]');
    ...
    define('APP_DB_HOST', isset($_ENV['APP_DB_HOST']) ? $_ENV['APP_DB_HOST'] : '[[softdbhost]]');
     ...
     * @ARG String
     */
    $GLOBALS['CONFIG']['db_prefix'] = isset($_ENV['DB_PREFIX']) ? $_ENV['DB_PREFIX'] : '[[dbprefix]]';
